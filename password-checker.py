...
# page styling
st.set_page_config(page_title="Password Strength Checker By Rubina", page_icon="🔑", layout="centered")
...
st.markdown("""
    ...
    .stButton button {width: 50%; background-color: #C875C4; color: white; font-size: 18px; }
    .stButton button:hover {background-color: #F81CO; } 
    </style>
    """,
